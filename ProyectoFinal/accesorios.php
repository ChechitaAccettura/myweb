...
<head>
    ...
    <title>Gabita's World - Accesorios </title>
</head>
<body>
<?php
...
/*  ---CONEXION CON LA BASE DE DATOS--- */
    ...
    $consulta="SELECT * FROM tiendagabita WHERE categoria = 'accesorio'";
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item justify-content-md-end">
                    <a href="login.html" class="nav-link" target="_blank" type="button">Acceso a Administradores</a>
                </li>
      ...
      <div class="row g-0">
        ...
        <div class="col-md-5">
          <div class="card-body">
            ...
            <button data-bs-toggle="modal" data-bs-target="#modal_<?php echo $registro['id']; ?>" class="btn btn-primary">Ver más...</button>
          </div>
        </div>
        <div class="col-md-3">
        </div>
